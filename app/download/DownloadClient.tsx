...
const SUPPORT_WHATSAPP = { name: 'Muhammad Iqbal', role: 'Project Director', number: '+923328001541', href: 'https://wa.me/923328001541' };
    ...
    <div>
      ...
      <section className={`py-8 sm:py-12 lg:py-20 transition-colors duration-300 ${
        ...
        <div className="max-w-full mx-auto px-3 sm:px-4 lg:px-8 xl:px-12 2xl:px-16">
          ...
          {/* Support - WhatsApp */}
          <div className={`mt-8 text-center p-4 rounded-xl transition-colors duration-300 ${
            theme === 'dark' ? 'bg-section-background/80' : 'bg-gray-100/80'
          }`}>
            <p className={`text-sm mb-2 transition-colors duration-300 ${
              theme === 'dark' ? 'text-primary-text' : 'text-light-primary-text'
            }`}>
              Need help? Contact support via WhatsApp or visit our Support page.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium text-white bg-green-600 hover:bg-green-700 transition-colors text-sm"
              >
