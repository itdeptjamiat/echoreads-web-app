...
const MagazinesClient: React.FC = () => {
  const { theme } = useTheme();
  const [selectedCategory, setSelectedCategory] = useState<string>('all');
  const { magazines, loading, error, refetch } = useMagazinesByType('magazine');
  useScrollToTop();
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          {filteredMagazines.length > 0 ? (
            ...
            <div className={`text-center py-12 transition-colors duration-300 ${
              ...
              <h2 className="text-xl font-semibold mb-2">No magazines found</h2>
...
export default MagazinesClient;
